...
public class MainActivity extends AppCompatActivity implements DialogGame.DialogGameListener {
    ...
    protected void onStart() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, PERMISSION_MULTIPLE);
    ...
    public void setFolders() {
        File dir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "A-Cube");
    ...
    public void applyTest(String userStr) {
        ...
        MainModel.getInstance().writeConfigurationsJson();
        MainModel.getInstance().writeGamesJson();
        TabGames.adapter.remove(gameRemove);
        TabGames.adapter.notifyDataSetChanged();
    }
}
